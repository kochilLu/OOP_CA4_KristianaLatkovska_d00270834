...
public class MySqlExpenseDao extends MySqlDao implements ExpenseDaoInterface{
    ...
    @Override
    public List<YearMonth> getListOfDistinctYearMonthsOfExpenses() throws DaoException
    {
        //initiating variables
        ...
        try
        {
            ...
            //preparing the SQL query
            String query = "SELECT DISTINCT MONTH(dateIncurred) AS `Month`, YEAR(dateIncurred) AS `Year` FROM expenses GROUP BY MONTH(dateIncurred), YEAR(dateIncurred);";
            ...
            throw new DaoException("getListOfDistinctYearMonthsOfExpensesSet() " + e.getMessage());
        }
        finally
        {
            try
            {
                ...
                throw new DaoException("getListOfDistinctYearMonthsOfExpenses() " + e.getMessage());
            }
        }
